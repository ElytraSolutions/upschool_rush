...
use OpenAdmin\Admin\Form\Field\Select as OASelect;
use OpenAdmin\Admin\Form\Field\Traits\CanCascadeFields;

/**
 * Created to enable multiple select using load function in single page.
 * Changes:
 * - switched 'let elm' to 'var elm'
 * - added 'view' property
 */
class Select extends Field
{
    ...
    public $view = 'admin.fields.select';
...
JS;
    ...
    public function allowedChoicesJs()
    {
        ...
        return in_array($class, [
            ...
            'App\Admin\Extensions\Form\Select',
        ]);
    }
